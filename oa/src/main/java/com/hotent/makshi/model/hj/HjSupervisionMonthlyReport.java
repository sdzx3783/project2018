 ...
 * 对象功能:00 Model对象
 */
public class HjSupervisionMonthlyReport extends WfBaseModel
{
	//主键
	protected Long id;
	/**
	...
	{
		if (!(object instanceof HjSupervisionMonthlyReport)) 
		{
			return false;
		}
		HjSupervisionMonthlyReport rhs = (HjSupervisionMonthlyReport) object;
