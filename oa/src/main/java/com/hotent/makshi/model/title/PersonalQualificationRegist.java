...
/**
 * 对象功能:个人执业资格初始注册 Model对象
 */
public class PersonalQualificationRegist extends BaseModel
{
	//主键
	protected Long id;
	/**
	...
	{
		if (!(object instanceof PersonalQualificationRegist)) 
		{
			return false;
		}
		PersonalQualificationRegist rhs = (PersonalQualificationRegist) object;
