 ...
 * 对象功能:党员档案 Model对象
 */
public class PartyFiles extends BaseModel
{
	//主键
	protected Long id;
	/**
	...
	{
		if (!(object instanceof PartyFiles)) 
		{
			return false;
		}
		PartyFiles rhs = (PartyFiles) object;
	...
	public PartyFiles(String party_num, String contact_situation,
			String user_num, String account, String out_contact,
			Date join_party_date, String out_tel, Date regular_date,
			String in_contact, String join_party_where, String in_tel,
			String regular_where, String place_of_influx, String introducer,
			Date lost_date, String branch, Date abroad_date,
			Date join_branch_date, String abroad_reason, String party_post,
			String abroad_situation, String org_relationship,
			String party_handling, Date out_date, Date return_date,
			String outgoing_flow, String restore_org_life, String out_type,
			String reviewer, String out_reason, String branch_review,
			String activity_num, String creator, Date create_time) {
		super();
		this.party_num = party_num;
		this.contact_situation = contact_situation;
		this.user_num = user_num;
