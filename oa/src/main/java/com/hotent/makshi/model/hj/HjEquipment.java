 ...
 * 对象功能:qq Model对象
 */
public class HjEquipment extends WfBaseModel
{
	//主键
	protected Long id;
	/**
	 ...
	 *维修单位
	 */
	protected String  maintaining_unit;
	/**
	 *备注
	 */
	...
	public void setMaintaining_unit(String maintaining_unit) 
	{
		this.maintaining_unit = maintaining_unit;
	}
	/**
	 * 返回 维修单位
	 * @return
	 */
	public String getMaintaining_unit() 
	{
		return this.maintaining_unit;
	}
	...
	{
		if (!(object instanceof HjEquipment)) 
		{
			return false;
		}
		HjEquipment rhs = (HjEquipment) object;
		...
		.append(this.maintaining_unit, rhs.maintaining_unit)
	...
	public String toString() 
	{
		...
		.append("maintaining_unit", this.maintaining_unit) 
