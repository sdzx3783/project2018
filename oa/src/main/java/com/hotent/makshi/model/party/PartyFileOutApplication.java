 ...
 * 对象功能:党员档案转出 Model对象
 */
public class PartyFileOutApplication extends BaseModel
{
	//主键
	protected Long id;
	/**
	...
	{
		if (!(object instanceof PartyFileOutApplication)) 
		{
			return false;
		}
		PartyFileOutApplication rhs = (PartyFileOutApplication) object;
