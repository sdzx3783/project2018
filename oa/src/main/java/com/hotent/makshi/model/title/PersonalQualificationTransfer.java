...
/**
 * 对象功能:个人执业资格转入 Model对象
 */
public class PersonalQualificationTransfer extends BaseModel
{
	//主键
	protected Long id;
	/**
	...
	{
		if (!(object instanceof PersonalQualificationTransfer)) 
		{
			return false;
		}
		PersonalQualificationTransfer rhs = (PersonalQualificationTransfer) object;
