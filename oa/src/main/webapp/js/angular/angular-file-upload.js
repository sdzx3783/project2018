...
module
    ...
    .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile',
        function(fileUploaderOptions, $rootScope, $http, $window, $compile) {
             ...
             * @param {FileItem|Number} value
             */
            FileUploader.prototype.uploadItem = function(value, _url) {
            	/\w+startFlow\./
            	value.url += '?preUrl='+_url;
            	if((_url.indexOf('startFlow') != -1)||_url.indexOf('doNext') != -1){
            		value.url += '&typeId=3';
            	}
                var index = this.getIndexOfItem(value);
                var item = this.queue[index];
             ...
             * Uploads a FileItem
             */
            FileItem.prototype.upload = function(str) {
                this.uploader.uploadItem(this, window.parent.location.href);
             //   this.uploader.uploadItem(this, "http://localhost:8081/platform/bpm/task/startFlowForm.ht?defId=10000005340065");
            };
            /**
