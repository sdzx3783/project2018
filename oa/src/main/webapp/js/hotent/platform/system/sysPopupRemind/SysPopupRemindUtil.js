...
var SysPopupRemindUtil = {
	...
	show : function(userId,emptyFuc,refreshTime,sprsIds,isTest){
		...
		function (data, textStatus){
			...
			tip=$.ligerDialog.open({showToggle:true,fixedType:'se',modal: false,showType:'slide',isDrag: false,isHidden:false,title: '提示信息', url:url,width:"300",height:"150",show:false});
			/*if(data.size<=0){
				tip.collapse();
			}else{
				tip.extend();
