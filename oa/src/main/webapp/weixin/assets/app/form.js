 ...
 */
.directive('htConselector', function() {
    return {
    	restrict : 'AE',
    	templateUrl:'conselector.html',
    	scope: {
    		htSelector:'='
    	},
    	replace:true,
        link: function(scope, element, attrs) {
        	...
        	var selector=scope.htConselector;
...
.directive('htInput', function() {
	return {
    	...
    	template:'<span>'
					...
					+'</span>'
					+'<span ng-show="permission==\'r\' || permission==\'r\'" ng-bind="htInput"></span>'
				 +'</span>',
        link: function(scope, element, attrs) {
        	scope.permission = attrs.permission;
        }
...
.directive('htTextarea', function() {
	return {
    	...
    	template:'<span>'
					...
					+'</span>'
					+'<div ng-show="permission==\'r\' || permission==\'rp\'" ng-bind="htTextarea"></div>'
				 +'</span>',
        link: function(scope, element, attrs) {
        	scope.permission = attrs.permission;
        }
