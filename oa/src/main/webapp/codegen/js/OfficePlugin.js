...
OfficePlugin={
		...
		init:function(){
			...
			for ( var i = 0; i < this.fileObjs.length; i++) {
				...
				//默认菜单权限，全部功能打开
				var menuRight = {wjRight:'y',lhRight:'n',blhRight:'n',qchjRight:'n',mbthRight:'y',xzmbRight:'y',sxqmRight:'n',gzRight:'n',qpRight:'n',zcpdfRight:'n',ekeygzRight:'n',pdfgzRight:'n'};
				//必填  已在其它处理
