...
<script type="text/javascript">
	...
	function recover(runId){
		FlowUtil.recover({runId:runId,backToStart:0,callback:function(){
			window.location.href="allRequestList.ht";
		}});
	}
	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="allRequestList.ht">
						<ul class="row">
		...
		<div class="panel-body">
			<display:table name="processRunList" id="processRunItem" requestURI="allRequestList.ht" sort="external" cellpadding="1"
				...
				<display:column property="creator" titleKey="发起人" sortable="true" sortName="creator" style="text-align:left"></display:column>
				<display:column property="startOrgName" titleKey="部门" sortable="true" sortName="startOrgName" style="text-align:left"></display:column>
