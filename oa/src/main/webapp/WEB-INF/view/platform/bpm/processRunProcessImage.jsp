	...
	<div class="panel-body">
		...
		<textarea id="txtTaskStatus" style="display:none">
			<#list data.taskOpinionList as obj>
				...
				<#if (obj.checkStatus == -1)> <!-- 正在审批 -->
					<tr>
						...
						<#if (obj.taskExeStatus==null)>
							<td></td>
						<#else>
							<td>\${obj.taskExeStatus.executor}--\${obj.taskExeStatus.mainOrgName}\${obj.taskExeStatus.isRead==false?"(未读)":"(已读)"}</td>
						</#if>
					</tr>
					<tr>
						<th>候选人: </th>
						...
						<#else>
							<td>
								<#list obj.candidateUserStatusList as candidateUserStatus>
									...
									\${candidateUserStatus.candidateUser}
				...
				<tr><th>意见: </th>
				<td name="opinionTd">\${obj.opinion==null?"":obj.opinion}</td></tr>
				</table><br>
			</#list>
		</textarea>
