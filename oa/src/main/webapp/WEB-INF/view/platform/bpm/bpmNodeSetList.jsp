										...
										<td class='formBox' >
											<table class="table-detail" >
												<tr>
													...
													<td>
														<select name="formType" class="selectForm" nodeId="${item.nodeId}" >
													...
													<tr>
														...
														<td>
															<div name="mobileForm">
																...
																<span name="spanForm"><a target="_blank" href="${ctx}/platform/form/bpmMobileFormDef/preview.ht?formKey=${item.mobileFormKey}" >${item.mobileFormName}</a></span>
																<a href="javascript:;" class="link get" onclick="setMobileForm(this)" >选择</a>
																<a href="javascript:;" class="link clean" onclick="clearForm(this)">重选</a>
															</div>
														</td>
