		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						<span class="label">名子:</span><input type="text" name="Q_name_SL"  class="inputText" />
						<span class="label">节点:</span><input type="text" name="Q_nodeid_SL"  class="inputText" />
						<span class="label">触发动作:</span><input type="text" name="Q_action_SL"  class="inputText" />
						<span class="label">流程key:</span><input type="text" name="Q_flowkey_SL"  class="inputText" />
						<span class="label">被触发流程:</span><input type="text" name="Q_triggerflowkey_SL"  class="inputText" />
						<span class="label">映射配置:</span><input type="text" name="Q_jsonmaping_SL"  class="inputText" />
						<span class="label">发起人配置:</span><input type="text" name="Q_userseting_SL"  class="inputText" />
						<span class="label">描述:</span><input type="text" name="Q_desc_SL"  class="inputText" />
					</div>
				</form>
			</div>
		</div>
		<div class="panel-body">
		    ...
		    <display:table name="bpmNewFlowTriggerList" id="bpmNewFlowTriggerItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:220px">
					...
					<a href="get.ht?id=${bpmNewFlowTriggerItem.id}" class="link detail">明细</a>
				</display:column>
			</display:table>
