...
<html>
    <head>
        ...
        <script type="text/javascript">
                ...
                leftClickUrl= __ctx+'/platform/bpm/task/alreadyCompletedMattersList.ht'
         </script> 
    ...
    <body>
        <div id="defLayout" >
            ...
            <div position="center">
                <iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/task/alreadyCompletedMattersList.ht"></iframe>
            </div>
        </div>
    </body>
</html>
