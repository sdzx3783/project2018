	...
	<div class="panel">
		...
		<c:choose>
			<c:when test="${calculate.otNumber > 0 }">
				<div class="smallTitle1" style="width: 550px;">
					<span class="spanRight" style="width: 10%">描叙</span>
					<span class="">${calculate.otRecord}</span>
				</div>
				<%-- <div class="smallTitle1" style="width: 550px;">
					<span class="spanRight" style="width: 10%">补偿方式</span>
					<span class="">${calculate.otRecord}</span>
				</div> --%>
			</c:when>
			<c:otherwise>
		...
		<c:choose>
			<c:when test="${calculate.holidayNumber > 0 }">
				<div class="smallTitle1" style="width: 550px;">
					<span class="spanRight" style="width: 10%">描叙</span>
					<span class="">${calculate.holidayRecord}</span>
				</div>
			</c:when>
			<c:otherwise>
				<div class="smallTitle1" ><span class="spanRight">无</span><span class="spanLeft"></span></div>
		...
		<c:choose>
			<c:when test="${calculate.tripNumber > 0 }">
				<div class="smallTitle1" style="width: 550px;">
					<span class="spanRight" style="width: 10%">描叙</span>
					<span class="">${calculate.tripRecord}</span>
				</div>
			</c:when>
			<c:otherwise>
				<div class="smallTitle1" ><span class="spanRight">无</span><span class="spanLeft"></span></div>
