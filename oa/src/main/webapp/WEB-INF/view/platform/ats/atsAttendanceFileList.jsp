			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						...
						<input type="text" id="fullname" name="Q_fullname_SL" value="${param['Q_fullname_SL']}" />
						<span class="label">组织:</span>
							<input type="hidden" id="orgId" name="Q_orgId_L" value="${param['Q_orgId_L']}"  />
							<input type="text" id="orgName" name="Q_orgName_SL" value="${param['Q_orgName_SL']}" readonly="readonly"/>
