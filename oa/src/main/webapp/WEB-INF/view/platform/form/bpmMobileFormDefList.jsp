		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht?__FILTERKEY__=${busQueryRule.filterKey}&__IS_QUERY__=0">
					<div class="row">
						<span class="label">表单key:</span><input type="text" name="Q_form_key_SL"  class="inputText" />
						<span class="label">表单标题:</span><input type="text" name="Q_subject_SL"  class="inputText" />
						<span class="label">表名:</span><input type="text" name="Q_table_Name_SL"  class="inputText" />
					</div>
				</form>
			</div>
		</div>
