	...
	<div>
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group">
					<a class="link  del" href="javascript:window.onbeforeunload = null;window.close()">
						<span></span>
						关闭
					</a>
				</div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table-detail">
					<tr>
						...
						<td style="padding: 4px;">
							<input id="formKey" type="text" name="formKey" value="${bpmFormDef.formKey}" <c:if test="${bpmFormDef.formDefId>0 }">readonly='readonly'</c:if> class="inputText" style="width: 100px" />
						</td>
						<th width="80">表单标题:&nbsp;</th>
						<td style="padding: 4px;">
