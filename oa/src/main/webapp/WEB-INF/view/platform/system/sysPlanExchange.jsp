...
<body class="oa-mw-page">
	...
	<div class="oa-pd20 oa-pdb0">
		...
		<c:if test="${sysPlan.rate!=100}">
			<a class="oa-button oa-button--primary oa-button--blue" id="editSysPlan" href="${ctx}/platform/system/sysPlan/edit.ht?id=${sysPlan.id}&currentViweDate=${currentViweDate}&type=${type}" >编辑</a>
			<a class="oa-button oa-button--primary oa-button--blue" id="finishSysPlan">完成任务</a>
		</c:if>

		<c:if test="${type ne 'myPlan'}">
			<a class="oa-button oa-button--primary oa-button--blue" id='delSysPlan'  href="#">删除</a>
		</c:if>
		...
		<c:choose>
			...
			<c:otherwise>
				<a class="oa-button oa-button--primary oa-button--blue" href="${ctx}/platform/system/sysPlan/charge.ht?currentViweDate=${currentViweDate}">返回</a>
			</c:otherwise>
		</c:choose>
	...
	<div class="oa-pd20">
		...
		<form id="sysPlanExchange" method="post" action="">
			...
			<table class="oa-table--default" cellpadding="0" cellspacing="0" border="0">				 
				...
				<tr>
					<th>交流信息:</th>
					<td colspan="3" class="inne-table-wrap">

						<c:if test="${sysPlan.rate!=100}">
							<button type="button" id="addSysPlanExchange" class="oa-button oa-button--primary oa-button--blue">添加</button>
						</c:if>
