			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht?__FILTERKEY__=${busQueryRule.filterKey}&__IS_QUERY__=0">
					<div class="row">
						...
						<span class="label">sql语句:</span><input type="text" name="Q_sql_SL"  class="inputText" value="${param['Q_sql_SL']}" />
						<span class="label">数据源名称:</span><input type="text" name="Q_dsname_SL"  class="inputText" value="${param['Q_dsname_SL']}" />
						<span class="label">按钮定义:</span><input type="text" name="Q_buttonDef_SL"  class="inputText" value="${param['Q_buttonDef_SL']}" />
					</div>
				</form>
			</div>
		</div>
