...
<body>
	...
	<div class="oa-pd20">
			...
			<table class="oa-table--default" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<th width="20%">收信人:</th>
					<td colspan="3">
					<f:receiverName messageId="${messageSend.id}" />
					</td>
				</tr>
				<tr>
					<th width="20%">附件:</th>
	...
	<iframe id="detailFrame" width="100%" frameborder="0"
	...
	<textarea id="txtReceiveTemplate" style="display: none;">
	    <table class="oa-table--default" cellpadding="0" cellspacing="0" border="0">
	  		...
	  		<tr>
	  			<th>\${obj_index+1}</th>
	  			<td>
					<a href="${ctx}/platform/system/sysUser/get.ht?userId=\${obj.userId}&hasClose=true&canReturn=-1"
