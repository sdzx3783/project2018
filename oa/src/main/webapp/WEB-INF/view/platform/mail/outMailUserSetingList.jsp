...
<style>
    ...
    #outMailUserSetingItem th a,
    #outMailUserSetingItem th{
        font-weight: 100;
        color: #657386;
    }
    #outMailUserSetingItem th{
    ...
    function test(id){
        ...
        $.post("test.ht",param,function(data){
            ...
            if(obj.isSuccess()){//成功
                ...
                $.ligerDialog.err("提示信息","测试连接失败!",obj.getMessage());
            }
        });
    }
</script>
                ...
                <div class="panel-top">
                    ...
                    <div class="panel-toolbar">
                        <div class="toolBar">
                            ...
                            <div class="group"><a class="link add" href="edit.ht?"><span></span>添加其他邮件账户</a></div>
                            <div class="l-bar-separator"></div>
