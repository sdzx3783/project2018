	...
	<script type="text/javascript">
		...
		function showResponse(responseText) {
			...
			if (obj.isSuccess()) {
				...
				$.ligerDialog.err("提示信息","加班保存失败!",obj.getMessage());
			}
		}
					...
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td><input type="text" id="startTime" name="startTime" 
								...
								class="inputText datetime" validate="{date:true,dateRangeEnd:'endTime'}" datetype="datetime"/></td>
						</tr>
						<tr>
							<th width="20%">结束时间: </th>
							<td><input type="text" id="endTime" name="endTime" validate="{date:true,dateRangeStart:'startTime'}"
