...
<script type="text/javascript">
	...
	function exportXml(){	
		...
		var url=__ctx + "/platform/bpmCommonWsSet/bpmCommonWsSet/exportXml.ht?tableIds="+tableIds;
		if (tableIds  ==''){
	...
	//导入Web服务调用配置
	function importXml(){
		var url=__ctx + "/platform/bpmCommonWsSet/bpmCommonWsSet/import.ht";
		ImportExportXml.showModalDialog({url:url,title:'导入Web服务调用配置'});
	}
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						...
						<span class="label">wsdl地址:</span><input type="text" name="Q_wsdlUrl_SL"  class="inputText" value="${param['Q_wsdlUrl_SL'] }" />
					</div>
				</form>
			</div>
		</div>
