	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group">
						<a class="link save" infoMsg="保存" action="/makshi/project/classifylib/afterAndPrestagetask.ht"><span></span>保存</a>
					</div>
				</div>	
			</div>
		...
		<div class="panel-body">
		   ...
		   <%--  <display:table name="stagelibList" id="stagelib" requestURI="selector.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
			...
			<c:forEach items="${classifyStageTaskList }" var="stageTask" varStatus="vs">
				<tr>
					<td><input type="checkbox" name="selectedId" class="pk" value="${stageTask.id }"/></td>
					<td>${vs.index+1 }</td>
