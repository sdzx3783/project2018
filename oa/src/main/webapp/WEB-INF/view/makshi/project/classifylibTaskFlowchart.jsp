...
<body >
<a class="link back"   href="/makshi/project/classifylib/stageTaskList.ht?classifystageid=${id }&classifylibid=${classifylibid}">返回</a>
	...
	var datasobj=JSON.parse('${data.datas}');
	var linksobj=JSON.parse('${data.links}');
	 var data =datasobj; /* [{
	     name: '节点1',
	     code: 'node1',
	     value: {
