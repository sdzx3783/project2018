...
<body class="oa-mw-page">
   ...
   <div id="oa_list_title" class="oa-mgb20 oa-project-title">
    ...
    <div id="oa_list_search" class="oa-pdb10 oa-mgh20">
        <form id="searchForm" method="post" action="myProList.ht" class="oa-clear">
    ...
    <div class="oa-pdb20 oa-mgh20">
        <div id="oa_list_content" class="oa-table-scroll-wrap">
    	    <display:table name="list" id="projectItem" requestURI="myProList.ht" sort="external" cellpadding="1" cellspacing="1" class="oa-table--default oa-table--nowrap">
	    		...
	    		<display:column title="操作" media="html">
    				<c:if test="${projectItem.isCharger }">
                        <a href="edit.ht?id=${projectItem.id}" class="oa-button-label">编辑</a>
    					<a href="getTask.ht?id=${projectItem.id}&from=myprolist" class="oa-button-label"><span></span>配置</a>
                    </c:if>
    			</display:column>
    		</display:table>
        </div>
