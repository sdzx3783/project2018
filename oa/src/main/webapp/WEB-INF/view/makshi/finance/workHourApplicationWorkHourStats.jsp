...
<body>
	...
	<div id="oa_list_search" class="oa-pd20 my-condition">
        <form id="searchForm" method="post" action="workHourStats.ht" class="oa-clear">
	...
	<div class="oa-pdb20 oa-mgh20">
	    <form method="POST"  enctype="multipart/form-data" id="form1" action="uploadUserCostExcel.ht"> 
	    	<div class="upfile-wrapper">
	    		<div class="file-prefer">
	    			<label>上传员工工时成本文件:</label>
             ...
             $(function(){
            	 $("#exportBtn").click(function exportExcel(){
            		var orgID=$("input[name='orgID']").val();
            		 ...
            		 $("#exportBtn").off("click");
            		 var url="exportWorkCostStatsExcel.ht"
