        ...
        <div class="__container__wrap">
            ...
            <div class="__aside fr">
                <div class="__aside__wrap">
                    ...
                    <div class="__section">
                        <div class="__section__head">
                            <h2 class="__section__title">学习资料 <span>Learning Materials</span>&nbsp&nbsp&nbsp&nbsp<a href="/makshi/doc/docinfo/filelist.ht?docId=30000000550027">添加</a></h2>
                            <c:if test="${not empty xxzl_list && fn:length(xxzl_list)>=5}">
                                <div class="__section__more">
                                    <a class="__section__link" href="/makshi/doc/docinfo/filelist.ht?docId=${xxzlId}&portalOrgId=${orgId}&from=orgportalindex">更多...</a>
                                </div>
                            </c:if>
                        </div>
                        <div class="__section__main __section__main--normol __section__main--row3">
                            <ul class="__section__list">
                                <c:forEach items="${xxzl_list}" var="docFile">
                                    <li class="__section__item">
                                        <h3 class="__section__item-title">
                                            <a href="/makshi/doc/docinfo/filedetail.ht?id=${docFile.dfid}" class="__section__link">${docFile.title}</a>
                                        </h3>
                                ...
                                <c:if test="${empty xxzl_list || fn:length(xxzl_list)<=0}">
                                    <li class="__section__item">
                                        <h3 class="__section__item-title">
                                            当前没有记录...
                                        </h3>
