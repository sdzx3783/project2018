...
<table class="formTable" border="1" cellspacing="0" cellpadding="2" parser="addpermission" data-sort="sortDisabled"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td style="width: 35%; word-break: break-all;" class="formInput"> <span name="editable-input" style="display:inline-block;" isflag="tableflag"> ${recruitmentApplication.applicant} </span> </td> 
  ...
  <tr> 
   ...
   <td style="width: 35%; word-break: break-all;" class="formInput"><br /> 
    <div name="div_attachment_container" right="r"> 
     ...
     <textarea style="display:none" controltype="attachment" name="file" lablename="附件" readonly="readonly">${recruitmentApplication.file}</textarea> 
    </div> </td> 
