...
<body>
    ...
    <div class="oa-main-wrap">
        <table class="formTable" border="1" cellspacing="0" cellpadding="2" data-sort="sortDisabled" parser="addpermission">
            <tbody>
                <tr class="firstRow">
                    <td class="formHead" colspan="4">监管方案</td>
                </tr>
                <tr>
                    <td align="right" class="formTitle">提交人:</td>
                    <td class="formInput"> ${hjRegulatoryScheme.name} </td>
                    <td align="right" class="formTitle">提交日期:</td>
                    <td class="formInput"><fmt:formatDate value='${hjRegulatoryScheme.date}' pattern='yyyy-MM-dd'/> </td>
                </tr>
                <tr>
                    <td align="right" class="formTitle">所属部门:</td>
                    <td class="formInput"> ${hjRegulatoryScheme.department} </td>
                    <td align="right" class="formTitle">项目名称:</td>
                    <td class="formInput">${hjRegulatoryScheme.project_name}</td>
                </tr>
                <tr>
                    <td align="right" class="formTitle">方案名称:</td>
                    <td class="formInput">${hjRegulatoryScheme.n_name}</td>
                    <td align="right" class="formTitle">方案内容:</td>
                    <td class="formInput"> <span name="editable-input" isflag="tableflag"> ${hjRegulatoryScheme.content} </span> </td>
                </tr>
                <tr>
                    <td align="right" class="formTitle">备注:</td>
                    <td class="formInput" rowspan="1" colspan="3"> <span name="editable-input" isflag="tableflag"> ${hjRegulatoryScheme.note} </span> </td>
                </tr>
                <tr>
                ...
                <tr style="display:none">
                    <td class="formInput" colspan="1" rowspan="1"> <span name="editable-input" isflag="tableflag"> ${hjRegulatoryScheme.projectTaskId} </span> </td>
                </tr>
            </tbody>
        </table>
    </div>
