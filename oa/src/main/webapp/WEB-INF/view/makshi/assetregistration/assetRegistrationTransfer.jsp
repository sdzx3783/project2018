...
<div class="panel" style="height:100%;overflow:auto;">
 ...
 <tbody>
  <tr class="firstRow">
   <td class="formHead" colspan="4" style="word-break: break-all;">资产移交</td>
  </tr>
  <tr>
   ...
   <td style="width: 35%" class="formInput">
    <span name="editable-input" style="display:inline-block;" isflag="tableflag"> 
        ...
        <input type="hidden" name="m:asset_registration:asset_id" lablename="资产编号" class="inputText" value="${assetRegistration.asset_id}" validate="{maxlength:50}" isflag="tableflag" readonly="readonly"/>
    </span>
   </td>
   ...
   <td style="width: 35%" class="formInput">
    ...
    <span name="editable-input" style="display:none;" isflag="tableflag"> 
        <input id="get_date_value" parser="datetable" name="m:asset_registration:get_date" lablename="取得日期" class="Wdate" displaydate="0" datefmt="yyyy-MM-dd" value="" validate="{empty:false}" type="text" readonly="readonly"/>
    </span> 
   </td>
  </tr>
    <tr>
  ...
  <tr>
   ...
   <td style="width: 35%" class="formInput">
<%--        <span name="editable-input" style="display:inline-block;" isflag="tableflag"> 
        <input readonly="readonly" type="text" name="m:asset_registration:care_person" lablename="保管人" class="inputText" value="${assetRegistration.care_person}" validate="{maxlength:50}" isflag="tableflag" />
    </span> --%>
    <input parser="selectortable" name="m:asset_registration:care_person" type="text" ctltype="selector" class="users" lablename="保管人" value="${assetRegistration.care_person}" validate="{empty:false}" readonly="readonly" scope="{&#39;value&#39;:&#39;all&#39;,&#39;type&#39;:&#39;system&#39;}"/>
    <%-- <input name="m:asset_registration:care_personID" value="${assetRegistration.care_personID}" > --%>
   </td>
   <td style="width: 15%; word-break: break-all;" class="formTitle" align="right">使用部门:</td>
   <td style="width: 35%" class="formInput">
    <%-- <span name="editable-input" style="display:inline-block;" isflag="tableflag"> 
        <input type="text" name="m:asset_registration:use_department" lablename="使用部门" class="inputText" value="${assetRegistration.use_department}" validate="{maxlength:50}" isflag="tableflag" />
    </span> --%>
     <input parser="selectortable" name="m:asset_registration:use_department" ctltype="selector" class="orgs" lablename="使用部门" value="${assetRegistration.use_department}" validate="{empty:false}" scope="{&#39;value&#39;:&#39;all&#39;,&#39;type&#39;:&#39;system&#39;}" type="text"
   </td>
  </tr>
  <tr>
   ...
   <td class="formInput" >
    <span  id="abandonment_date" style="">
  ...
  <tr>
   ...
   <td style="width: 35%" class="formInput">
    <span name="editable-input" style="display:inline-block;" isflag="tableflag"> 
        ...
        <input type="hidden" readonly="readonly" type="text" name="m:asset_registration:asset_name" lablename="资产名称" class="inputText" value="${assetRegistration.asset_name}" validate="{maxlength:50}" isflag="tableflag" />
    </span>
   </td>
  ...
  <tr>
   ...
   <span name="editable-input" style="display:inline-block;" isflag="tableflag"> 
     ...
     <input type="hidden" readonly="readonly" type="text" name="m:asset_registration:specification" lablename="规格型号" class="inputText" value="${assetRegistration.specification}" validate="{maxlength:50}" isflag="tableflag" /> </span> </td>
   <td style="width: 15%; word-break: break-all;" class="formTitle" align="right">数量:</td>
   <td style="width: 35%" class="formInput"> 
   <span name="editable-input" style="display:inline-block;" isflag="tableflag"> 
   <input readonly="readonly" type="text" name="m:asset_registration:number" lablename="数量" class="inputText" value="${assetRegistration.number}" validate="{maxlength:50}" isflag="tableflag" /> </span> </td>
  </tr>
  <tr>
   ...
   <span name="editable-input" style="display:inline-block;" isflag="tableflag"> 
        ...
        <input type="hidden" readonly="readonly" name="m:asset_registration:version" lablename="资产类别" class="inputText" value="${assetRegistration.version}" validate="{maxlength:50}" isflag="tableflag" />
   </td>
   <td style="width: 15%; word-break: break-all;" class="formTitle" align="right">使用状况:</td>
   <td style="width: 35%" class="formInput">
    <c:if test="${assetRegistration.state==0}">在用</c:if>
    <c:if test="${assetRegistration.state==1}">报废</c:if>
    <span name="editable-input" style="display:none;padding:2px;" class="selectinput"> 
    ...
    <option value="0">在用</option> <option value="1">报废</option> </select> 
    </span> 
