			...
			$.post("run.ht?isList=1&id="+id+"&runId="+runId,function(responseText){
				...
				if (obj.isSuccess()) {
					$.ligerDialog.success("启动流程成功！", "成功", function(rtn) {
						this.close();
						window.location.href = "${ctx}/makshi/asset_application/assetAll/getMyDraft.ht";
					});
				} else {
...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="assetAllList" id="assetAllItem" requestURI="getMyDraftJson.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:220px">
					<c:if test="${assetAllItem.runId==0}">
						...
						<a href="javascript:;" onclick="startFlow(this,'${assetAllItem.id}','${assetAllItem.runId}')" class="link run"><span></span>提交</a>
					</c:if>
				</display:column>
			</display:table>
