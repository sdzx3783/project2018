...
<html>
<head>
	<title id="executiveTitle">员工考核列表</title>
...
<body>
	<div id="oa_list_title" class="oa-mgb20 oa-project-title">
	    <h2 class='executivetitle'>员工考核列表</h2>
	</div>
	<div>
        <div class="col-md-12">
        	<a class="oa-button oa-button--primary oa-button--blue" href="/makshi/assess/employee/edit.ht" >添加</a>
			<form class="form-inline" role="form" method="post" action="/makshi/assess/employee/main.ht" id="search-form">
		         <div class="form-body">
	...
	<script type="text/javascript" src="${ctx}/js/makshi/assess/employee.js"></script>
</body>
</html>