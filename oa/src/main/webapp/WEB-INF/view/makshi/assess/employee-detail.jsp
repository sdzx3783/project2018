...
<body>
				  ...
				  <div class="oa-mw-page">
				   	<div class="border-wrapper">
				    	<div class="line table-head">
						     ...
						     <div class="oa-input-wrap--ib" style="margin-left:60px;">
						      	考评日期： <fmt:formatDate value="${dto.evaluation_at }" pattern="yyyy年MM月"/> 
						     </div>
				    	</div>
				   	</div>
				  </div>
				  <table class="formTable" border="1" cellspacing="0" cellpadding="2" data-sort="sortDisabled">
				   	<tbody>
					    ...
					    <tr>
					     ...
					     <td class="formTitle zy1">${dto.self_zy_self1 }</td>
					     <td class="formTitle zy1">${dto.self_zy_depart1 }</td>
					     <td class="formTitle zy1">${dto.self_zy_leader1 }</td>
					     <td class="formTitle" id="zytotal1"></td>
					    </tr>
					    <tr>
					     <td class="formTitle zy2">${dto.self_zy_self2 }</td>
					     <td class="formTitle zy2">${dto.self_zy_depart2}</td>
					     <td class="formTitle zy2">${dto.self_zy_leader2}</td>
					     <td class="formTitle" id="zytotal2"></td>
					    </tr>
					    <tr>
					     <td class="formTitle zy3">${dto.self_zy_self3 }</td>
					     <td class="formTitle zy3">${dto.self_zy_depart3}</td>
					     <td class="formTitle zy3">${dto.self_zy_leader3}</td>
					     <td class="formTitle" id="zytotal3"></td>
					    </tr>
					    <tr>
					     <td class="formTitle zy4">${dto.self_zy_self4 }</td>
					     <td class="formTitle zy4">${dto.self_zy_depart4}</td>
					     <td class="formTitle zy4">${dto.self_zy_leader4}</td>
					     <td class="formTitle" id="zytotal4"></td>
					    </tr>
					    <tr>
					     <td class="formTitle" align="right" rowspan="4" colspan="1">2.工作态度</td>
					     ...
					     <td class="formTitle td1">${dto.self_td_self1 }</td>
					     <td class="formTitle td1">${dto.self_td_depart1}</td>
					     <td class="formTitle td1">${dto.self_td_leader1}</td>
					     <td class="formTitle" id="tdtotal1"></td>
					    </tr>
					    <tr>
					     <td class="formTitle td2">${dto.self_td_self2 }</td>
					     <td class="formTitle td2">${dto.self_td_depart2}</td>
					     <td class="formTitle td2">${dto.self_td_leader2}</td>
					     <td class="formTitle" id="tdtotal2"></td>
					    </tr>
					    <tr>
					     <td class="formTitle td3">${dto.self_td_self3 }</td>
					     <td class="formTitle td3">${dto.self_td_depart3}</td>
					     <td class="formTitle td3">${dto.self_td_leader3}</td>
					     <td class="formTitle" id="tdtotal3"></td>
					    </tr>
					    <tr>
					     <td class="formTitle td4">${dto.self_td_self4 }</td>
					     <td class="formTitle td4">${dto.self_td_depart4}</td>
					     <td class="formTitle td4">${dto.self_td_leader4}</td>
					     <td class="formTitle" id="tdtotal4"></td>
					    </tr>
					    <tr>
					     <td class="formTitle" align="right" rowspan="4" colspan="1">3.工作能力</td>
					     ...
					     <td class="formTitle nl1">${dto.self_nl_self1 }</td>
					     <td class="formTitle nl1">${dto.self_nl_depart1}</td>
					     <td class="formTitle nl1">${dto.self_nl_leader1}</td>
					     <td class="formTitle" id="nltotal1"></td>
					    </tr>
					    <tr>
					     <td class="formTitle nl2">${dto.self_nl_self2 }</td>
					     <td class="formTitle nl2">${dto.self_nl_depart2}</td>
					     <td class="formTitle nl2">${dto.self_nl_leader2}</td>
					     <td class="formTitle" id="nltotal2"></td>
					    </tr>
					    <tr>
					     <td class="formTitle nl3">${dto.self_nl_self3 }</td>
					     <td class="formTitle nl3">${dto.self_nl_depart3}</td>
					     <td class="formTitle nl3">${dto.self_nl_leader3}</td>
					     <td class="formTitle" id="nltotal3"></td>
					    </tr>
					    <tr>
					     <td class="formTitle nl4">${dto.self_nl_self4 }</td>
					     <td class="formTitle nl4">${dto.self_nl_depart4}</td>
					     <td class="formTitle nl4">${dto.self_nl_leader4}</td>
					     <td class="formTitle" id="nltotal4"></td>
					    </tr>
					    <tr>
					     <td class="formTitle" align="right" rowspan="4" colspan="1">4.工作效果</td>
					     ...
					     <td class="formTitle xg1">${dto.self_xg_self1 }</td>
					     <td class="formTitle xg1">${dto.self_xg_depart1}</td>
					     <td class="formTitle xg1">${dto.self_xg_leader1}</td>
					     <td class="formTitle" id="xgtotal1"></td>
					    </tr>
					    <tr>
					     <td class="formTitle xg2">${dto.self_xg_self2 }</td>
					     <td class="formTitle xg2">${dto.self_xg_depart2}</td>
					     <td class="formTitle xg2">${dto.self_xg_leader2}</td>
					     <td class="formTitle" id="xgtotal2"></td>
					    </tr>
					    <tr>
					     <td class="formTitle xg3">${dto.self_xg_self3}</td>
					     <td class="formTitle xg3">${dto.self_xg_depart3}</td>
					     <td class="formTitle xg3">${dto.self_xg_leader3}</td>
					     <td class="formTitle" id="xgtotal3"></td>
					    </tr>
					    <tr>
					     <td class="formTitle xg4">${dto.self_xg_self4}</td>
					     <td class="formTitle xg4">${dto.self_xg_depart4}</td>
					     <td class="formTitle xg4">${dto.self_xg_leader4}</td>
					    ...
					    <tr>
					     ...
					     <td class="formTitle selftotal">${dto.self_total }</td>
					     <td class="formTitle departtotal">${dto.depart_total}</td>
					     <td class="formTitle leadertotal">${dto.leader_total}</td>
	...
	<script type="text/javascript" src="${ctx}/js/makshi/assess/employee-detail.js"></script>
</body>
</html>
