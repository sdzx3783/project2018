...
<body>
	<div id="oa_list_title" class="oa-mgb20 oa-project-title">
	    <h2 class='executivetitle'>合同收款明细表</h2>
	</div>
	<div  >
        <div class="col-md-12">
			<form class="form-inline" role="form" method="post" action="/makshi/gates/executive/detail/contractBilling.ht" id="search-form">
	...
	<script type="text/javascript" src="${ctx}/js/makshi/gates/executive/executiveDetailContractBillingMain.js"></script>
</body>
</html>