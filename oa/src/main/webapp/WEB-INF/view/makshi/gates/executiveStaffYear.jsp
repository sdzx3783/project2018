...
<body>
	<div id="oa_list_title" class="oa-mgb20 oa-project-title">
	    <!-- <h2 class='executivetitle'>员工分析报表（年度）</h2> -->
	</div>
        <div class="col-md-12">
			<form class="form-inline" role="form" method="post" action="/makshi/gates/executive/peopleYear.ht"  id="toolbootbar">
		         <div class="form-body">
							...
							<c:otherwise>
								<c:forEach items="${list }" var="e" varStatus="v">
									<tr>
										...
										<td><fmt:formatNumber value="${e.yearAverageNum}" pattern="##.##"></fmt:formatNumber></td>
	...
	<script type="text/javascript" src="${ctx }/js/makshi/gates/executive/executiveStaffYear.js" ></script>
</body>
</html>