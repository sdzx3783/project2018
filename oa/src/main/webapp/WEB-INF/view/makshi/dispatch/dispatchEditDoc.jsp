...
<div class="panel" style="height:100%;overflow:auto;">
	<form id="docinfoForm" method="post" action="/makshi/doc/docinfo/save.ht">
		<table class="table">
			<tr>
				<th>分类名称: </th>
				<td>
					<select name="docname" class="oa-new-select" style="width: 100px;" value="${docinfo.docname}">
		...
		<input type="hidden" id="orgid" name="orgid" value="7"/>
		<input type="hidden" id="supid" name="docsupid" value="7"/>
	...
	function showResponse(responseText) {
		...
		if (obj.isSuccess()) {
			$.ligerDialog.confirm(obj.getMessage()+",是否继续操作","提示信息", function(rtn) {
				if(rtn){
					closeAll();
					$.post("/makshi/dispatch/dispatch/editDoc.ht",{},function(data){
						var d = dialog({
							title : "新建文档目录",
							fixed : true,
							content : data
