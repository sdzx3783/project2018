  ...
  <tbody> 
   ...
   <c:forEach items="${entry_familyList}" var="entry_family" varStatus="status">
    <tr class="listRow" type="subdata"> 
     <td> <span name="editable-input" style="display:inline-block;" isflag="tableflag"> <input type="text" name="s:entry_family:relationship" lablename="关系" class="inputText" value="${entryFamily.relationship}" validate="{maxlength:50}" isflag="tableflag" /> </span> </td> 
     <td></td> 
     <td></td> 
     <td></td> 
     <td></td> 
  ...
  <tbody> 
   ...
   <c:forEach items="${entry_education_historyList}" var="entry_education_history" varStatus="status">
    <tr class="listRow" type="subdata"> 
     <td></td> 
     <td></td> 
     <td> <span name="editable-input" style="display:inline-block;" isflag="tableflag"> <input type="text" name="s:entry_education_history:major" lablename="专业" class="inputText" value="${entryEducationHistory.major}" validate="{maxlength:50}" isflag="tableflag" /> </span> </td> 
     <td></td> 
     <td></td> 
    </tr>
   </c:forEach> 
