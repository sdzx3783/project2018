...
<body class="oa-mw-page">
    ...
    <div class="oa-mg20">
        <button class="oa-button oa-button--primary oa-button--blue" onclick="window.location.href='/makshi/task/task/newlist.ht?type=${type}&stage=${stage}'">返回</button>
    ...
    <div class="oa-mg20">
        <form id="projectForm" method="post" action="newsave.ht?type=${type}">
        ...
        if (obj.isSuccess()) {
            $.ligerDialog.confirm(obj.getMessage()+",是否继续操作","提示信息", function(rtn) {
                if(rtn){
                    ...
                    window.location.href = "/makshi/task/task/newlist.ht?type=${type}&stage=${stage}";
                }
            });
        } else {
