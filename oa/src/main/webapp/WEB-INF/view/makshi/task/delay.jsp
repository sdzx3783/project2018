...
<body>
    ...
    <div class="oa-project-content">
        <form id="projectForm" method="post" action="delay.ht">
            <table class="oa-table">
                ...
                <tr>
                    <th>延期至：</th>
					<td>
						<input type="hidden" id="date" name="date" value="<fmt:formatDate value='${task.endDate }' pattern='yyyy-MM-dd'/>" />
                      <div class="oa-input-wrap">
                          <input type="text" id="endDate"  name="endDate"  class="oa-input Wdate" validate="{date:true,required:true}"
                           onClick="WdatePicker({minDate:'#F{$dp.$D(\'date\');}'})" />
                      </div>
                    </td>
                </tr>
                <tr>
