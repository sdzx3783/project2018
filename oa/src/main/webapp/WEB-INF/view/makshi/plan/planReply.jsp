...
<body>
    ...
    <div class="oa-project-search">
        <button class="oa-button oa-button--primary oa-button--blue" onclick="window.location.href='/makshi/plan/plan/underList.ht'">返回</button>
        <button class="oa-button oa-button--primary oa-button--blue" id="dataFormSave">保存</button>
    </div>
    <div class="oa-project-content">
        <form id="projectForm" method="post" action="reply.ht">
            ...
            <table class="oa-table">
            	...
            	<tr>
                    <th>评论：</th>
                    <td>
                    	<textarea style="height:300px;width:400px;" id="reply" name="reply"></textarea>
                    </td>
                </tr>
            </table>
        ...
        if (obj.isSuccess()) {
            $.ligerDialog.confirm(obj.getMessage()+",是否继续操作","提示信息", function(rtn) {
                if(rtn){
                    ...
                    window.location.href = "/makshi/plan/plan/underList.ht";
                }
            });
        } else {
