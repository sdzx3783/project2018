...
<style type="text/css">
	...
	<script type="text/javascript">
		...
		function onClick(treeNode){
			var url="${ctx}/demo/LigerUI/lgeditors/list.ht";
...
<body>
   	<div id="defLayout" >
         <div position="left" title="树分类管理" style="overflow: auto;float:left;width:100%">
         ...
         <div position="center">
        	<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/demo/LigerUI/lgeditors/list.ht"></iframe>
         </div>
     </div>
</body>
</html>
