...
public class SysUserDao extends BaseDao<SysUser> implements UserDetailsService {
	 ...
	 * @return
	 */
	public List<SysUser> getAllByOrgId(List<String> orgList) {
		return this.getBySqlKey("getAllByOrgId", orgList);
	}
	 ...
	 * @return
	 */
	public List<SysUser> getUserByBlurOrgName(QueryFilter queryFilter)
	{ 
		return getBySqlKey("getUserByBlurOrgName", queryFilter);
	}
	 ...
	 * @return
	 */
	public List<SysUser> getAllAllUserByOrg(QueryFilter queryFilter) {
		return this.getBySqlKey("getAllAllUserByOrg", queryFilter);
	}
	...
	{
		List<Integer> list = this.getBySqlKeyGenericity("getUsersByQuery4Count", new HashMap<String, Object>());
	...
	{
		return this.getBySqlKey("getUsersByQuery4SMS", params);
	}
}