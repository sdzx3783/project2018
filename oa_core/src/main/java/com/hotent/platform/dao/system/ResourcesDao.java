...
public class ResourcesDao extends BaseDao<Resources>
{
	 ...
	 * @return
	 */
	public List<Resources> getNormMenuByRoleAndOrg(long systemId,Long userId,Long resOrgId ){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("systemId", systemId);
		p.put("userId", userId);
		p.put("resOrgId", resOrgId);
	 ...
	 * @return
	 */
	public List<Resources> getNormMenuByAllRoleAndOrg(long systemId,String rolealias,Long resOrgId  ){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("systemId", systemId);
		p.put("rolealias", rolealias);
		p.put("resOrgId", resOrgId);
	 ...
	 * @return
	 */
	public List<Resources> getSuperMenuByAllRoleAndOrg(long systemId,Long resOrgId  ){
		Map<String, Object> p=new HashMap<String, Object>();
		p.put("systemId", systemId);
		p.put("resOrgId", resOrgId);
