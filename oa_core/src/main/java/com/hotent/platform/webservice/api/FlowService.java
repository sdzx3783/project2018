...
//	@WebMethod(operationName = "getMyFlowListJson")
	@GET
	@Path("/getMyFlowListJson")
//	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Produces({MediaType.APPLICATION_JSON,MediaType.APPLICATION_ATOM_XML})
	public String getMyFlowListJson(@QueryParam("account") String account);
...
//	@WebMethod(operationName = "getMyTaskByAccount")
	@GET
	@Path("/getMyTaskByAccount")
	@Produces({MediaType.APPLICATION_JSON,MediaType.APPLICATION_ATOM_XML})
	public String getMyTaskByAccount(@QueryParam("account") String account);
	 ...
	 */
	@GET
	@Path("/alreadyCompletedMattersList")
	@Produces({MediaType.APPLICATION_JSON,MediaType.APPLICATION_ATOM_XML})
	public String alreadyCompletedMattersList(@QueryParam("account") String account);
...
//	@WebMethod(operationName = "getMyRequestListJson")
	@GET
	@Path("/getMyRequestListJson")
	@Produces({MediaType.APPLICATION_JSON,MediaType.APPLICATION_ATOM_XML})
	public String getMyRequestListJson(@QueryParam("account") String account);
...
//	@WebMethod(operationName = "getMyCompletedListJson")
	@GET
	@Path("/getMyCompletedListJson")
	@Produces({MediaType.APPLICATION_JSON,MediaType.APPLICATION_ATOM_XML})
	public String getMyCompletedListJson(@QueryParam("account") String account);
