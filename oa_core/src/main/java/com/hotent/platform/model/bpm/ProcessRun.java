...
public class ProcessRun extends BaseModel  implements Cloneable,IProcessRun {
	...
	/** 废除 */
	public static final Short STATUS_Abolish = 11;
	...
	//申请部门Id
	protected Long creatDepartmentId;
	//申请部门
	protected String creatDepartment;
	// 创建时间
	...
	public Long getCreatDepartmentId() {
		return creatDepartmentId;
	}

	public void setCreatDepartmentId(Long creatDepartmentId) {
		this.creatDepartmentId = creatDepartmentId;
	}

	public String getCreatDepartment() {
		return creatDepartment;
	}

	public void setCreatDepartment(String creatDepartment) {
		this.creatDepartment = creatDepartment;
	}
