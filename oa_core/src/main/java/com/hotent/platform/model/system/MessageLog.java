...
public class MessageLog extends BaseModel {
	...
	//发送短信给接口，接口返回一个MSGID,唯一标记一条短信
	protected String msgSendId;

	//短信发送状态 -10未知，即未查询接口获取短信状 0成功 其他未成功
	protected Integer msgToMobStatus;
	...
	public Integer getMsgToMobStatus() {
		return msgToMobStatus;
	}

	public void setMsgToMobStatus(Integer msgToMobStatus) {
		this.msgToMobStatus = msgToMobStatus;
	}
