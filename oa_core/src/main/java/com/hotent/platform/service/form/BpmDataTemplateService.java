...
public class BpmDataTemplateService extends BaseService<BpmDataTemplate> {
	...
	public String getForm(String alias, String pk,String ctxPath) throws Exception {
		...
		String form=bpmFormDefService.parseHtml(bpmFormDef, pk, instanceId, actDefId, "", parentActDefId, false,false,true,false);
		return form;
	}
	...
	private void handSub(Map<String, List<DataEntity>> subDataEntityMap, BpmFormData bpmFormData, String importType) throws Exception {
		...
		for (Iterator<Entry<String, List<DataEntity>>> it = subDataEntityMap.entrySet().iterator(); it.hasNext();) {
			...
			Map.Entry<String, List<DataEntity>> e = (Map.Entry<String, List<DataEntity>>) it.next();
			String key = e.getKey();
