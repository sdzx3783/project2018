...
public class UserPositionService extends BaseService<UserPosition>
{
	...
	public UserPosition getUserPosition(Long userId,Long posId){
	...
	public String getUsernamesByPosId(Long posId){
		...
		if(BeanUtils.isNotEmpty(userPositionList)){
			...
			for(UserPosition userPosition:userPositionList){
				...
				userNames.append(ServiceUtil.getUserLinkOpenWindowAndPostId(userPosition.getUserId().toString(),
						userPosition.getUserName(),userPosition.getUserPosId()+""));
			}
		}
