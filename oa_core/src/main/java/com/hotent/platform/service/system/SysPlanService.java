...
public class SysPlanService extends BaseService<SysPlan>
{
	...
	//任务保存日程
	public String saveTaskSysPlan(SysPlan sysPlan,Map<String,Object> params){
		String resultMsg="保存日程失败！";
		if(sysPlan==null){
			return resultMsg;
		}
...
//		}
	 ...
	 * 添加日程对外接口
	 * @param sysPlan 日程数据
	 * @param participantIds //参与人ID
	 * @param participants//参与人名称
	 * @return
	 */
	public String saveSysPlanOut(SysPlan sysPlan,String participantIds,String participants){
		String resultMsg="保存日程失败！";
		if(sysPlan==null){
			return resultMsg;
		}
	 ...
	 * @return
	 */
	public List<SysPlan> getMySchedule(QueryFilter queryFilter){
		return sysPlanDao.getMySchedule(queryFilter);
	}
	
	
	public SysPlan getByTaskNameAndCTime(String taskName,String date){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("taskName", taskName);
		map.put("date", date);
		return sysPlanDao.getUnique("getByTaskNameAndCTime", map);
	}
