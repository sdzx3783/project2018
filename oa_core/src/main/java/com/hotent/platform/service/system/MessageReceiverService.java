...
public class MessageReceiverService extends BaseService<MessageReceiver>
{
	...
	public MessageReceiver getByMsgIdReId(Long messageId,Long receiverId){
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("messageId", messageId);
		params.put("receiverId", receiverId);
		return dao.getUnique("getByMsgIdReId", params);
		
	}
	
	public int getNotReadMsgCount(Long userId){
		return dao.getNotReadMsgCount(userId);
	}
}
