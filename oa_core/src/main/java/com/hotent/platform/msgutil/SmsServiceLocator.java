...
public class SmsServiceLocator extends org.apache.axis.client.Service implements SmsService {
    ...
    private String Sms_address = "http://218.17.200.209:8080/services/Sms";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Sms.class.isAssignableFrom(serviceEndpointInterface)) {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://218.17.200.209:8080/services/Sms", "SmsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://218.17.200.209:8080/services/Sms", "Sms"));
        }
